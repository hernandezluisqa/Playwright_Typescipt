...
Given('el usuario se encuenta en la pagina de Login de Home Banking', async function (this: CustomWorld) {
...
Then('debería ser redirigido al panel principal del usuario {string}', async function (this: CustomWorld, userNameExpected: string) {
  const profilePage = new ProfilePage(this.page!);
  const actualUSername = await profilePage.getUsername();
